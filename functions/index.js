 ...
 */
const scrapeProductDetails = onCall(async (request) => {
 ...
 */
const sendPushNotificationV2 = onDocumentCreated("notifications/{notificationId}", async (event) => {
...
// EXPORTS
// ============================================================================
export { scrapeProductDetails, pingV2, sendPushNotificationV2 };
